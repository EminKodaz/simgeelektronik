...
import PasswordDemandHeader from "@/components/PasswordDemand/PasswordDemandHeader";
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Şifrenizi unuttuysanız şifre talep edebilir bizimle iletişime geçebilirsiniz." />
          ...
          >
            <section className="md:mt-44">
              ...
              <p className="px-20 max-lg:px-0 max-lg:text-left text-center text-xl mt-5 font-semibold text-zinc-600">
                {t("passwordDemandDescription")}
              </p>
            </section>
          </InviewAnimate>
          <PasswordDemandHeader />
        </div>
      </main>
    </>
  );
