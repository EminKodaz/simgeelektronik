...
export default async function handler(req, res) {
  if (req.method === "POST") {
    ...
    const { fullName, email, aboneNo } = req.body;
    const message = `
    Name: ${fullName}\r\n
    Email: ${email}\r\n
    Abone No: ${aboneNo}\r\n
                                                          ...
                                                          <td
                                                            ...
                                                            <div>
                                                              <div style="font-family: inherit; text-align: center"><span
                                                                  style="font-size: 43px">Thanks for signing up,
                                                                  ${fullName}!</span></div>
                                                              <div></div>
                                                            </div>
                                                          </td>
                                                      ...
                                                      <tbody>
                                                        <tr>
                                                          <td
                                                            ...
                                                            <div>
                                                              <div style="font-family: inherit; text-align: center"><span
                                                                  style="color: #ffffff; font-size: 18px"><strong>Here’s what
                                                                    happens next:</strong></span></div>
                                                              <div style="font-family: inherit; text-align: center"><br></div>
                                                              <div style="font-family: inherit; text-align: center"><span
                                                                  style="color: #ffffff; font-size: 18px">1. Upload your
                                                                  resume and we'll keep it on file for every job
                                                                  submission.</span></div>
                                                              <div style="font-family: inherit; text-align: center"><br></div>
                                                              <div style="font-family: inherit; text-align: center"><span
                                                                  style="color: #ffffff; font-size: 18px">2. Submit and edit
                                                                  personalized cover letters for every job you apply
                                                                  to.</span></div>
                                                              <div style="font-family: inherit; text-align: center"><br></div>
                                                              <div style="font-family: inherit; text-align: center"><span
                                                                  style="color: #ffffff; font-size: 18px">3. Get access to our
                                                                  career coaches when you need 1:1 help with your job
                                                                  application.</span></div>
                                                              <div style="font-family: inherit; text-align: center"><span
                                                                  style="color: #ffbe00; font-size: 18px"><strong>+ much
                                                                    more!</strong></span></div>
                                                              <div style="font-family: inherit; text-align: center"><br></div>
                                                              <div style="font-family: inherit; text-align: center"><span
                                                                  style="color: #ffffff; font-size: 18px">Need support? Our
                                                                  support team is always</span></div>
                                                              <div style="font-family: inherit; text-align: center"><span
                                                                  style="color: #ffffff; font-size: 18px">ready to
                                                                  help!</span></div>
                                                              <div></div>
                                                            </div>
                                                          </td>
                                                        ...
                                                        <tr>
                                                          <td align="center" bgcolor="#6e6e6e" class="outer-td"
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0"
                                                              ...
                                                              <tbody>
                                                                <tr>
                                                                  <td align="center" bgcolor="#ffbe00" class="inner-td"
