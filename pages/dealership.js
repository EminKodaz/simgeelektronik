      ...
      <main className="flex flex-col m-auto min-h-screen text-center">
        ...
        <div className="z-10 my-44 min-[2000px]:w-[60%] max-[1300px]:w-[95%] max-lg:w-[90%] w-[75%] max-lg:mt-32 m-auto">
          ...
          <InviewAnimate
            ...
            className="w-full"
          >
            <article className="w-full h-full md:h-[36rem] md:px-8 md:py-4 px-3 gap-2 mt-14 flex flex-col md:flex-row justify-between items-center md:rounded-[2.5rem] rounded-2xl bg-lightred relative">
              <MdLogin
